...
import { clearMessage, deleteReview, fetchAdminProducts, fetchProductReviews, removeErrors, resetDeleteReviewSuccess } from '../features/admin/adminSlice';
import { toast } from 'react-toastify';
import Loader from '../components/Loader';
import { useNavigate } from 'react-router-dom';

function ReviewsList() {
    const {products,loading,error,reviews,deleteReviewSuccess,message} = useSelector(state=>state.admin);
   ...
   useEffect(()=>{
    ...
    },[dispatch,error,deleteReviewSuccess,message,navigate])
                        ...
                        {products.map((product,index)=>(
                            <tr key={product._id}>
                                ...
                                <td>
                                    ...
                                    onClick={()=>handleViewReviews(product._id)}>View Reviews</button>)}
                                </td>
                        </tr>))}
                    </tbody>
                </table>
