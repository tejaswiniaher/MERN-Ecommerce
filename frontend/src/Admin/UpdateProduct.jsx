        ...
        <>
            ...
            <div className="update-product-wrapper">
                ...
                <form className="update-product-form" encType='multipart/form-data' onSubmit={updateProductSubmit}>
                    ...
                    <input type="text" className='update-product-input' required id='name' name='name'
                        value={name} onChange={(e) => setName(e.target.value)} />

                    <label htmlFor="price">Product Price</label>
                    <input type="number" className='update-product-input' required id='price' name='price'
                        value={price} onChange={(e) => setPrice(e.target.value)} />

                    <label htmlFor="description">Product Description</label>
                    <textarea type="text" className='update-product-textarea' required id='description' name='description'
                    ...
                    <input type="number" className='update-product-input' required id='stock' name='stock'
                        value={stock} onChange={(e) => setStock(e.target.value)} />

                    <label htmlFor="image">Product Images</label>
                    <div className="update-product-file-wrapper">
                        <input id="image" type="file" accept='image/*' name='image' multiple className='update-product-file-input'
